...
class Tests(unittest.TestCase):
    ...
    def test_day_20(self):
        self.assertEqual(day_20.run(), (32287787075651, 1939))

    def test_day_21(self):
        self.assertEqual(day_21.run(), (2436, 'dhfng,pgblcd,xhkdc,ghlzj,dstct,nqbnmzx,ntggc,znrzgs'))

    def test_day_22(self):
        self.assertEqual(day_22.run(), (34566, 31854))

    def test_day_23(self):
        self.assertEqual(day_23.run(), (82635947, 157047826689))

    def test_day_24(self):
        self.assertEqual(day_24.run(), (282, 3445))

    def test_day_25(self):
        self.assertEqual(day_25.run(), (6421487, False))